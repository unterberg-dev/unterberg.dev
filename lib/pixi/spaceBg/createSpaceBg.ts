...
const createSpaceBg = async (app: Application) => {
  ...
  gsap.set(layer1Sprite, { alpha: 0.3 })
  ...
  gsap.set(layer2Sprite, { alpha: 0.2 })
  ...
  const tile: SpaceTile = {
    layer1: layer1Sprite,
    layer1ToX: gsap.quickTo(layer1Sprite, 'x', { duration: 2, ease: 'power3' }),
    layer1ToY: gsap.quickTo(layer1Sprite, 'y', { duration: 2, ease: 'power3' }),
    layer2: layer2Sprite,
    layer2ToX: gsap.quickTo(layer2Sprite, 'x', { duration: 2, ease: 'power1' }),
    layer2ToY: gsap.quickTo(layer2Sprite, 'y', { duration: 2, ease: 'power1' }),
  }
  setSpaceStore({
    spaceBg: tile,
  })
